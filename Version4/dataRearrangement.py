...
def delete_trackableID():    #delete the column trackableID
    with open("/Users/liuliu/myDocuments/flare_down/code/Version4/txtFileOfCsv.txt", 'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version4/delete_trackableID.txt", 'w') as fout:
            for line in fin:
                record=line.split(',')
...
def rearrange():           #rearrange data such that all information under the same user will be grouped
    with open ("/Users/liuliu/myDocuments/flare_down/code/Version4/delete_trackableID.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version4/rearrange.txt",'w') as fout:
            preID = ""
            for line in fin:
...
def sort_by_date():             #sort every group according to dates and delete all date afterwards
    with open("/Users/liuliu/myDocuments/flare_down/code/Version4/rearrange.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version4/sort_by_date.txt",'w') as fout:
            module=[]
            for line in fin:
                record=line.split(',')
                if("==" in record[0]):
...
def discard_noSymptoms():   #discard groups with no symptoms i.e. no y value
    with open("/Users/liuliu/myDocuments/flare_down/code/Version4/sort_by_date.txt", 'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version4/discard_noSymptoms.txt", 'w') as fout:
            module = []
            for line in fin:
                flag = False
                if ("==" in line):
...
def discard_treatment_weather_zeroSymptom():  #discard all treamtment, weather, and symptoms with zeros
    with open("/Users/liuliu/myDocuments/flare_down/code/Version4/discard_noSymptoms.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version4/discard_treatment_weather_zeroSymptom.txt",'w') as fout:
            for line in fin:
                record=line.split(',')
                flag=True
...
def seperate_groups():  #seperate groups such that every group ends with some symptoms and discard those without a symptom at the end
    with open("/Users/liuliu/myDocuments/flare_down/code/Version4/discard_treatment_weather_zeroSymptom.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version4/seperate_groups.txt",'w') as fout:
            module = []
            symptom_flag=False
            for line in fin:
                if ("==" in line):
...
def read_dic():    #read in the dic for conditions, tags, and symptoms
    with open("/Users/liuliu/myDocuments/flare_down/code/Version4/dic.txt",'r') as fin:
...
def data_in_dic():  #keep only the data that is in the dic
    with open("/Users/liuliu/myDocuments/flare_down/code/Version4/seperate_groups.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version4/data_in_dic.txt",'w') as fout:
            allDic = read_dic()
...
def keep_good_data():  #keep data that have enough for the algorithm to make predications
    with open("/Users/liuliu/myDocuments/flare_down/code/Version4/data_in_dic.txt", 'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version4/keep_good_data.txt",'w') as fout:
            module = []
            for line in fin:
                if ("==" in line):
                    flag=True
...
def convert_to_number():  #convert all strings to numbers for machine learning
    ...
    with open("/Users/liuliu/myDocuments/flare_down/code/Version4/keep_good_data.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version4/training.txt", 'w') as fout1:
            with open("/Users/liuliu/myDocuments/flare_down/code/Version4/dev.txt", 'w') as fout2:
                s=""
