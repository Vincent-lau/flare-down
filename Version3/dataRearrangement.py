...
def delete_trackableID():    #delete the column trackableID
    with open("/Users/liuliu/myDocuments/flare_down/code/Version3/txtFileOfCsv.txt", 'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version3/delete_trackableID.txt", 'w') as fout:
            for line in fin:
                record=line.split(',')
...
def rearrange():           #rearrange data such that all information under the same user will be grouped
    with open ("/Users/liuliu/myDocuments/flare_down/code/Version3/delete_trackableID.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version3/rearrange.txt",'w') as fout:
            preID = ""
            for line in fin:
...
def sort_by_date():             #sort every group according to dates and delete all date afterwards
    with open("/Users/liuliu/myDocuments/flare_down/code/Version3/rearrange.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version3/sort_by_date.txt",'w') as fout:
            module=[]
            for line in fin:
                record=line.split(',')
                if("==" in record[0]):
...
def discard_noSymptoms():   #discard groups with no symptoms i.e. no y value
    with open("/Users/liuliu/myDocuments/flare_down/code/Version3/sort_by_date.txt", 'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version3/discard_noSymptoms.txt", 'w') as fout:
            module = []
            for line in fin:
                flag = False
                if ("==" in line):
...
def discard_treatment_weather_zeroSymptom():  #discard all treamtment, weather, and symptoms with zeros
    with open("/Users/liuliu/myDocuments/flare_down/code/Version3/discard_noSymptoms.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version3/discard_treatment_weather_zeroSymptom.txt",'w') as fout:
            for line in fin:
                record=line.split(',')
                flag=True
...
def select_symptom():  #choose the symptom with the highest number among consecutive symptoms
    with open("/Users/liuliu/myDocuments/flare_down/code/Version3/discard_treatment_weather_zeroSymptom.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version3/select_symptom.txt",'w') as fout:
            symptoms=[]
            for line in fin:
                record=line.split(',')
                if(record[0]!="Symptom"):
...
def seperate_groups():
    ...
    with open("/Users/liuliu/myDocuments/flare_down/code/Version3/select_symptom.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version3/seperate_groups.txt",'w') as fout:
            module = []
            for line in fin:
                if ("==" in line):
                    till_symptom = []
...
def read_dic():    #read in the dic for conditions, tags, and symptoms
    with open("/Users/liuliu/myDocuments/flare_down/code/Version3/dic.txt",'r') as fin:
...
def data_in_dic():  #keep only the data that is in the dic
    with open("/Users/liuliu/myDocuments/flare_down/code/Version3/seperate_groups.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version3/data_in_dic.txt",'w') as fout:
            allDic = read_dic()
...
def convert_to_number():  #convert all strings to numbers for machine learning
    ...
    with open("/Users/liuliu/myDocuments/flare_down/code/Version3/data_in_dic.txt",'r') as fin:
        with open("/Users/liuliu/myDocuments/flare_down/code/Version3/training.txt", 'w') as fout1:
            with open("/Users/liuliu/myDocuments/flare_down/code/Version3/dev.txt", 'w') as fout2:
                s=""
                ...
                for line in fin:
                    ...
                    if("==" in record[0] ):
                       ...
                       # s+=record[0]
                        ...
                        symptoms_value=symptoms_dic[record[1]]
...
def plot_Kmeans_error(X,type):     #plot k-means error to choose number of centroids
    error=[]
    for i in range(4,30):
...
print(conditions_vec_list)
plot_Kmeans_error(conditions_vec_list,"number of clusters for conditions")
plot_Kmeans_error(tags_vec_list,"number of clusters for tags")
plot_Kmeans_error(symptoms_vec_list,"number of clusters for symptoms")
#----------------------------------------------------------------------------
