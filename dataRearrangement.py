...
def delete_dateAndtrackableID():
    with open ("flare_down/txtFileOfCsv.txt",'r') as fin:
        with open("flare_down/delete_dateAndtrackableID.txt",'w') as fout:
            for line in fin:
                counter=0
                for s in line.split(','):
...
def rearrange():           #rearrange data such that all information under the same user will be grouped
    with open ("flare_down/delete_dateAndtrackableID.txt",'r') as fin:
        with open("flare_down/rearrange.txt",'w') as fout:
            preID = ""
            for line in fin:
...
def get_allConditions():
    conditions={}
    with open("flare_down/rearrange.txt",'r') as fin:
        for line in fin:
            record=line.split(',')
...
def discard_low_frequency_features():
    ...
    with open ("flare_down/rearrange.txt",'r') as fin:
        with open("flare_down/discard_less_frequent_features.txt",'w') as fout:
            for line in fin:
...
def remove_incomplete_data():
    ...
    with open("flare_down/discard_less_frequent_features.txt",'r') as fin:
        with open("flare_down/remove_incomplete_data.txt",'w') as fout:
            module=[""]
            for line in fin:
                flag=True
                if("==" in line):
...
def twoFrequentFeaturesBeforeSymptom():
    with open("flare_down/remove_incomplete_data.txt",'r') as fin:
        with open("flare_down/twoFrequentFeaturesBeforeSymptom.txt",'w') as fout:
...
def allFrequentConditionsBeforeSymptom():
    with open("flare_down/remove_incomplete_data.txt", 'r') as fin:
        with open("flare_down/allFrequentConditionsBeforeSymptom.txt", 'w') as fout:
...
def generateCountries():
    with open("flare_down/allFrequentConditionsBeforeSymptom.txt",'r') as fin:
        with open("flare_down/countries.txt",'w') as fout:
            countries=[]
            for line in fin:
                if("==" in line):
                    tmp=line.split(',')
...
def convert_to_number():
    ...
    with open("flare_down/allFrequentConditionsBeforeSymptom.txt",'r') as fin:
        with open("flare_down/final.txt", 'w') as fout:
            s=""
            conditons=[0]*6
            tagNum=0
            symNum=0
