...
def csv_to_text(): #need to deal with "Incontinence urine"
    with codecs.open("/Users/liuliu/Desktop/Python/flare_down/fd-export2.csv", 'r', encoding="utf-8") as f1:
        with codecs.open("/Users/liuliu/Desktop/Python/flare_down/Version5/txtFileOfCsv.txt", "w",encoding="utf-8") as f2:
...
def remove_quotes():  #remove quotes around "Incontinence urine"
    with codecs.open("/Users/liuliu/Desktop/Python/flare_down/Version5/txtFileOfCsv.txt", 'r', encoding="utf-8") as fin:
        with codecs.open("/Users/liuliu/Desktop/Python/flare_down/Version5/remove_quotes.txt", "w",encoding="utf-8") as fout:
            for line in fin:
                record=line.split(',')
...
def delete_trackableID():    #delete the column trackableID
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/txtFileOfCsv.txt", 'r',encoding="utf-8") as fin:
        with open("/Users/liuliu/Desktop/Python/flare_down/Version5/delete_trackableID.txt", 'w',encoding="utf-8") as fout:
            for line in fin:
                record=line.split(',')
...
def rearrange():           #rearrange data such that all information under the same user will be grouped
    with open ("/Users/liuliu/Desktop/Python/flare_down/Version5/delete_trackableID.txt",'r',encoding="utf-8") as fin:
        with open("/Users/liuliu/Desktop/Python/flare_down/Version5/rearrange.txt",'w',encoding="utf-8") as fout:
            preID = ""
            for line in fin:
...
def sort_by_date():             #sort every group according to dates and delete all date afterwards
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/rearrange.txt",'r',encoding="utf-8") as fin:
        with open("/Users/liuliu/Desktop/Python/flare_down/Version5/sort_by_date.txt",'w',encoding="utf-8") as fout:
            module=[]
            for line in fin:
                record=line.split(',')
                if("==" in record[0]):
...
def discard_noSymptoms():   #discard groups with no symptoms i.e. no y value
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/sort_by_date.txt", 'r',encoding="utf-8") as fin:
        with open("/Users/liuliu/Desktop/Python/flare_down/Version5/discard_noSymptoms.txt", 'w',encoding="utf-8") as fout:
            module = []
            for line in fin:
                flag = False
                if ("==" in line):
...
def discard_treatment_weather_zeroSymptom():  #discard all treamtment, weather, and symptoms with zeros
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/discard_noSymptoms.txt",'r',encoding="utf-8") as fin:
        with open("/Users/liuliu/Desktop/Python/flare_down/Version5/discard_treatment_weather_zeroSymptom.txt",'w',encoding="utf-8") as fout:
            for line in fin:
                record=line.split(',')
                flag=True
...
def seperate_groups():  #seperate groups such that every group ends with some symptoms and discard those without a symptom at the end
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/discard_treatment_weather_zeroSymptom.txt",'r',encoding="utf-8") as fin:
        with open("/Users/liuliu/Desktop/Python/flare_down/Version5/seperate_groups.txt",'w',encoding="utf-8") as fout:
            module = []
            symptom_flag=False
            for line in fin:
                if ("==" in line):
...
def write_dic(countries,conditions,tags,symptoms):
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/dic.txt",'w',encoding="utf-8") as fout:
        fout.write("COUNTRY\n")
        for s in countries:
...
def read_dic():    #read in the dic for conditions, tags, and symptoms
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/dic.txt",'r',encoding='utf-8') as fin:
...
def data_in_dic():  #keep only the data that is in the dic
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/seperate_groups.txt",'r',encoding="utf-8") as fin:
        with open("/Users/liuliu/Desktop/Python/flare_down/Version5/data_in_dic.txt",'w',encoding="utf-8") as fout:
            allDic = read_dic()
...
#----------------------------------------------------------------------------
def keep_good_data():
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/data_in_dic.txt", 'r',encoding="utf-8") as fin:
        with open("/Users/liuliu/Desktop/Python/flare_down/Version5/keep_good_data.txt",'w',encoding="utf-8") as fout:
            module = []
            for line in fin:
                if ("==" in line):
                    flag=True
...
def convert_to_number():  #convert all strings to numbers for machine learning
    ...
    with open("/Users/liuliu/Desktop/Python/flare_down/Version5/keep_good_data.txt",'r',encoding="utf-8") as fin:
        with open("/Users/liuliu/Desktop/Python/flare_down/Version5/training.txt", 'w') as fout1:
            with open("/Users/liuliu/Desktop/Python/flare_down/Version5/test.txt", 'w') as fout2:
                s=""
...
f=open("/Users/liuliu/Desktop/Python/flare_down/Version5/tuning_result.txt",'w')
...
for i in range(40,50,10):
    for j in range(40,50,10):
        for k in range(40,50,10):
            ...
            X_train,Y_train,m_train=read_set("/Users/liuliu/Desktop/Python/flare_down/Version5/training.txt",symptom_size,overall_size)
            X_test,Y_test,m_test=read_set("/Users/liuliu/Desktop/Python/flare_down/Version5/test.txt",symptom_size,overall_size)
